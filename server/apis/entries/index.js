...
const { insertEntries, getEntries, updateById } = require('./repo');
const { insertMatchUps } = require('../matchup/repo'); // NOTE: If I ever want to microservice this, I need to re-architect it
